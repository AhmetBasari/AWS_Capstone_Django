...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/Ahmet/Capstone/username", WithDecryption=True)
    password_param = ssm.get_parameter(Name="/Ahmet/Capstone/Password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstone-rds.czoc8ge644so.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'capstone-blok' # please enter your s3 bucket name
